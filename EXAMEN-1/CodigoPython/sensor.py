...
def graficar_rangos_sensores(sensores, rango_deseado):
    ...
    for i, sensor in enumerate(sensores):
        ...
        plt.plot(sensor.temperaturas -273.15, np.ones(len(sensor.temperaturas))*(j), lw = 15, label=nombre_sensor)
...
graficar_rangos_sensores([sensor_PT1000, sensor_TYPE_K, sensor_TYPE_E, sensor_TYPE_TMP, sensor_NTCLE100E3338], (0, 100))
