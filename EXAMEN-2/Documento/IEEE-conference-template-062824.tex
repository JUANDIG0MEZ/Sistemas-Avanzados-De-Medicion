...
Con los parametros de la siguiente tabla es posible simular el comportamiento del sensor con una entrada de fuerza tal que:

\[
F = amplitud * \sin (2 * \pi * f * t)
\]
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\columnwidth]{../CodigoPython/segundo_orden.png}
	\caption{Descripción de la imagen.}
	\label{fig:segundo_orden}
\end{figure}

Postetiormente a la generación de simulación del sensor y el procesamiento de analogo a digital, la señal resultante a traves de utilizar filtro de kalman lineal es el siguiente:

\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\columnwidth]{../CodigoPython/estimacion_f_modelo_2.png}
	\caption{Descripción de la imagen.}
	\label{fig:f_modelo_2}
\end{figure}

En paralelo se hace la estimación por medio de series de Fourier lo que da como resultado:

\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\columnwidth]{../CodigoPython/estimacion_f_fourier_modelo_2.png}
	\caption{Descripción de la imagen.}
	\label{fig:f_modelo_2}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\columnwidth]{../CodigoPython/primer_orden.png}
	\caption{Descripción de la imagen.}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\columnwidth]{../CodigoPython/estimacion_u_kalman_modelo_1.png}
	\caption{Descripción de la imagen.}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\columnwidth]{../CodigoPython/estimacion_u_fourier_modelo_1.png}
	\caption{Descripción de la imagen.}
	\label{fig:u_modelo_1}
\end{figure}
